	...
	, d_ptr(d)
{
	...
	connect(d->StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &WaterfallStepHelperDialog::ClearParameters);
    connect(d->StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &WaterfallStepHelperDialog::SetDefaults1/*, Qt::QueuedConnection*/);
    connect(d->StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &WaterfallStepHelperDialog::SetDefaults100/*, Qt::QueuedConnection*/);
    connect(d->StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &WaterfallStepHelperDialog::SetDefaults0/*, Qt::QueuedConnection*/);
    connect(d->StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &WaterfallStepHelperDialog::CheckOkEnabled/*,Qt::QueuedConnection*/);
    connect(d->StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &WaterfallStepHelperDialog::ResetSoFCombo/*, Qt::QueuedConnection*/);
    connect(d->StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &WaterfallStepHelperDialog::ResetPayAccrueCombo/*, Qt::QueuedConnection*/);
...
void WaterfallStepHelperDialog::CheckOkEnabled(int index)
{
	...
	if (index != 0) {
        disconnect(d->StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), this, &WaterfallStepHelperDialog::CheckOkEnabled);
...
QWidget* WaterfallStepHelperDialogPrivate::CreateJuniorFeesWidget() {
	...
	q->connect(q, &WaterfallStepHelperDialog::SetPayAccrueCombo, SrcFndCmb, &QComboBox::setCurrentIndex);
    q->connect(SrcFndCmb, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), q, &WaterfallStepHelperDialog::PayAccrueComboChanged);
...
QWidget* WaterfallStepHelperDialogPrivate::CreateInterestWidget()
{
    ...
    q->connect(SenGrpEdit, &QLineEdit::textChanged, q, &WaterfallStepHelperDialog::SetSeniorityGroup);
    q->connect(StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), SenGrpEdit, &QLineEdit::clear);
    q->connect(q, &WaterfallStepHelperDialog::ImportSeniorityGroup, SenGrpEdit, &QLineEdit::setText, Qt::QueuedConnection);
    ...
    q->connect(SenLvlEdit, &QLineEdit::textChanged, q, &WaterfallStepHelperDialog::SetSeniorityGroupLevel);
    q->connect(StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), SenLvlEdit, &QLineEdit::clear);
    q->connect(q, &WaterfallStepHelperDialog::SetTo1, SenLvlEdit, &QLineEdit::setText);
    q->connect(q, &WaterfallStepHelperDialog::ImportSeniorityGroupLevel, SenLvlEdit, &QLineEdit::setText, Qt::QueuedConnection);
    ...
    q->connect(CoupIdxEdit, &QLineEdit::textChanged, q, &WaterfallStepHelperDialog::SetCouponIndex);
    q->connect(StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), CoupIdxEdit, &QLineEdit::clear);
    q->connect(q, &WaterfallStepHelperDialog::SetTo1, CoupIdxEdit, &QLineEdit::setText);
    q->connect(q, &WaterfallStepHelperDialog::ImportCouponIndex, CoupIdxEdit, &QLineEdit::setText, Qt::QueuedConnection);
...
QWidget* WaterfallStepHelperDialogPrivate::CreateICWidget()
{
    ...
    q->connect(TestOvrdEdit, &QLineEdit::textChanged, q, &WaterfallStepHelperDialog::SetTestTargetOverride);
    q->connect(StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), TestOvrdEdit, &QLineEdit::clear);
    q->connect(q, &WaterfallStepHelperDialog::ImportTestTargetOverride, TestOvrdEdit, &QLineEdit::setText, Qt::QueuedConnection);
...
QWidget* WaterfallStepHelperDialogPrivate::CreateOCWidget()
{
    ...
    q->connect(RedGrpEdit, &QLineEdit::textChanged, q, &WaterfallStepHelperDialog::SetRedemptionGroup);
    q->connect(StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), RedGrpEdit, &QLineEdit::clear);
    q->connect(q, &WaterfallStepHelperDialog::ImportRedemptionGroup, RedGrpEdit, &QLineEdit::setText, Qt::QueuedConnection);
    ...
    q->connect(RedLvlEdit, &QLineEdit::textChanged, q, &WaterfallStepHelperDialog::SetRedemptionGroupLevel);
	q->connect(StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), RedLvlEdit, &QLineEdit::clear);
	q->connect(q, &WaterfallStepHelperDialog::SetTo1, RedLvlEdit, &QLineEdit::setText);
    q->connect(q, &WaterfallStepHelperDialog::ImportRedemptionGroupLevel, RedLvlEdit, &QLineEdit::setText, Qt::QueuedConnection);
    ...
    q->connect(RedShrEdit, &QLineEdit::textChanged, q, &WaterfallStepHelperDialog::SetRedemptionShare);
	q->connect(StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), RedShrEdit, &QLineEdit::clear);
	q->connect(q, &WaterfallStepHelperDialog::SetTo100, RedShrEdit, &QLineEdit::setText);
	q->connect(q, &WaterfallStepHelperDialog::ImportRedemptionShare, RedShrEdit, &QLineEdit::setText, Qt::QueuedConnection);
	...
	q->connect(ColShrEdit, &QLineEdit::textChanged, q, &WaterfallStepHelperDialog::SetAdditionalCollateralShare);
	q->connect(StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), ColShrEdit, &QLineEdit::clear);
	q->connect(q, &WaterfallStepHelperDialog::SetTo0, ColShrEdit, &QLineEdit::setText);
	q->connect(q, &WaterfallStepHelperDialog::ImportAdditionalCollateralShare, ColShrEdit, &QLineEdit::setText, Qt::QueuedConnection);
...
QWidget* WaterfallStepHelperDialogPrivate::CreateReinvestPrincipalWidget()
{
    ...
    q->connect(q, &WaterfallStepHelperDialog::SetSoFCombo, SrcFndCmb, &QComboBox::setCurrentIndex);
    q->connect(SrcFndCmb, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), q, &WaterfallStepHelperDialog::SoFComboChanged);
	ResLay->addWidget(SrcFndLbl, CountRow, 0);
	ResLay->addWidget(SrcFndCmb, CountRow, 1);
	CountRow++;
...
QWidget* WaterfallStepHelperDialogPrivate::CreateReserveReplenishWidget()
{
    ...
    q->connect(ResIdxEdit, &QLineEdit::textChanged, q, &WaterfallStepHelperDialog::SetReserveIndex);
	q->connect(StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), ResIdxEdit, &QLineEdit::clear);
	q->connect(q, &WaterfallStepHelperDialog::ImportReserveIndex, ResIdxEdit, &QLineEdit::setText, Qt::QueuedConnection);
...
QWidget* WaterfallStepHelperDialogPrivate::CreateCurePDLWidget()
{
    ...
    q->connect(RedShrEdit, &QLineEdit::textChanged, q, &WaterfallStepHelperDialog::SetRedemptionShare);
	q->connect(StepSelectorCombo, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged), RedShrEdit, &QLineEdit::clear);
	q->connect(q, &WaterfallStepHelperDialog::SetTo0, RedShrEdit, &QLineEdit::setText);
	q->connect(q, &WaterfallStepHelperDialog::ImportRedemptionShare, RedShrEdit, &QLineEdit::setText, Qt::QueuedConnection);
	ResLay->addWidget(RedShrLbl, CountRow, 0);
	ResLay->addWidget(RedShrEdit, CountRow, 1);
	CountRow++;
