...
#include <QGridLayout>
PDLTriggerSettingWidget::PDLTriggerSettingWidget(QWidget *parent)
    : AbstractTriggerSettingWidget(parent)
{
    ...
    m_sizeLabel->setText(tr("Target size of the PDL"));
    ...
    m_senioritySideLabel->setText(tr("Side of the seniority ladder where the PDL is computed"));
    ...
    m_senioritySideCombo->addItem(tr("Senior"), static_cast<quint8>(PDLTrigger::TriggerSenioritySide::Senior));
    m_senioritySideCombo->addItem(tr("Junior"), static_cast<quint8>(PDLTrigger::TriggerSenioritySide::Junior));
    m_senioritySideCombo->addItem(tr("Exactly"), static_cast<quint8>(PDLTrigger::TriggerSenioritySide::Exactly));
    m_senioritySideCombo->addItem(tr("Senior or Equal"), static_cast<quint8>(PDLTrigger::TriggerSenioritySide::SeniorOrEqual));
    m_senioritySideCombo->addItem(tr("Junior or Equal"), static_cast<quint8>(PDLTrigger::TriggerSenioritySide::JuniorOrEqual));
    m_sizeSideCombo = new QComboBox(this);
    m_sizeSideCombo->addItem(tr("Bigger"), static_cast<quint8>(PDLTrigger::TriggerSizeSide::Bigger));
    m_sizeSideCombo->addItem(tr("Smaller"), static_cast<quint8>(PDLTrigger::TriggerSizeSide::Smaller));
    m_sizeSideCombo->addItem(tr("Exactly"), static_cast<quint8>(PDLTrigger::TriggerSizeSide::Exactly));
    m_sizeSideCombo->addItem(tr("Bigger or Equal"), static_cast<quint8>(PDLTrigger::TriggerSizeSide::BiggerOrEqual));
    m_sizeSideCombo->addItem(tr("Smaller or Equal"), static_cast<quint8>(PDLTrigger::TriggerSizeSide::SmallerOrEqual));
...
void PDLTriggerSettingWidget::setParameters(const QString& pars)
{
...
QString PDLTriggerSettingWidget::parameters() const
{
    if (
...
void PDLTriggerSettingWidget::reset()
{
