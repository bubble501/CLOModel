...
public:
	...
	double GetCoupon(int index = 0, qint32 CoupIndex = 0, int Frequency = 12) const;
	double GetRawCoupon(int index = 0, qint32 CoupIndex = 0) const;
	double GetRawCoupon(const QDate& index, qint32 CoupIndex = 0) const;
	...
	void SetInterestType(TrancheInterestType a, qint32 CoupIndex = 0) { InterestType[CoupIndex] = a; }
	...
	void SetDefaultRefRate(const QString& a) { SetReferenceRate(a,-1); }
