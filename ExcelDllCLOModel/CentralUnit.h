...
public:
	...
	void AddLoan(const QDate& Maturity, double Size, const QString& Interest, const QString& Annuity, int Freq=1,double floatBase=0.0, const QString& LossMult="100", const QString& PrepayMult="100", const QString& HaicutVect="0");
	...
	void SetReserveFund(int RFindex,const QString& RFtarget,const QString& RFmultiple,const QString& RFfloor,double RFcurrent,int RFfreed){Structure.SetReserveFund(RFindex,RFtarget,RFmultiple,RFfloor,RFcurrent,RFfreed);}
