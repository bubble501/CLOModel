...
public:
	...
	template<class T> double GetInterest(const T& index) const {static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetInterest can be used only with int or QDate"); return GenericCashFlow::GetFlow(index, static_cast<qint32>(MtgFlowType::InterestFlow)); }
	template<class T> double GetScheduled(const T& index) const { static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetScheduled can be used only with int or QDate"); return GenericCashFlow::GetFlow(index, static_cast<qint32>(MtgFlowType::PrincipalFlow)); }
	template<class T> double GetPrepay(const T& index) const {static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetPrepay can be used only with int or QDate"); return GenericCashFlow::GetFlow(index, static_cast<qint32>(MtgFlowType::PrepaymentFlow)); }
	template<class T> double GetPrincipal(const T& index) const { static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetPrincipal can be used only with int or QDate"); return GetScheduled(index) + GetPrepay(index); }
	template<class T> double GetLoss(const T& index) const {static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetLoss can be used only with int or QDate");	return GenericCashFlow::GetFlow(index, static_cast<qint32>(MtgFlowType::LossFlow)); }
	template<class T> double GetAmountOut(const T& index) const { static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetAmountOut can be used only with int or QDate"); return GenericCashFlow::GetFlow(index, static_cast<qint32>(MtgFlowType::AmountOutstandingFlow)); }
	template<class T> double GetAccruedInterest(const T& index) const { static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetAccruedInterest can be used only with int or QDate"); return GenericCashFlow::GetFlow(index, static_cast<qint32>(MtgFlowType::AccruedInterestFlow)); }
	template<class T> double GetLossOnInterest(const T& index) const { static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetLossOnInterest can be used only with int or QDate"); return GenericCashFlow::GetFlow(index, static_cast<qint32>(MtgFlowType::LossOnInterestFlow)); }
	template<class T> double GetDelinquent(const T& index) const { static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetDelinquent can be used only with int or QDate"); return GenericCashFlow::GetFlow(index, static_cast<qint32>(MtgFlowType::DelinquentOutstanding)); }
	template<class T> double GetPrepayFees(const T& index) const { static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetPrepayFees can be used only with int or QDate"); return GenericCashFlow::GetFlow(index, static_cast<qint32>(MtgFlowType::PrepaymentFees)); }
	...
	template<class T> double GetDefaults(const T& index) const { static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetDefaults can be used only with int or QDate"); return GenericCashFlow::GetFlow(index, static_cast<qint32>(MtgFlowType::PrincipalDefault)); }
	template<class T> double GetRecoveries(const T& index) const { static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetRecoveries can be used only with int or QDate"); return GenericCashFlow::GetFlow(index, static_cast<qint32>(MtgFlowType::PrincipalRecovered)); }
	template<class T> double GetInterestRecoveries(const T& index) const { static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetInterestRecoveries can be used only with int or QDate"); return GenericCashFlow::GetFlow(index, static_cast<qint32>(MtgFlowType::InterestRecovered)); }
	...
	template<class T>  double GetFlow(const T& index, MtgFlowType FlowTpe)const { static_assert(std::is_same<T, QDate>::value || std::is_integral<T>::value, "GetFlow can be used only with int or QDate"); return GenericCashFlow::GetFlow(index, static_cast<qint32>(FlowTpe)); }
