...
int main(int argc, char *argv[]) {
	...
	*///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	out >> TempMtg;
	file.close();
    Mortgage amtg(*(TempMtg.GetLoans().begin().value()));
    amtg.CalculateCashFlows(QDate(2015, 6, 15), "20", "0 12S 3", "35");
    PrintToTempFile("startingHaircut", amtg.GetCashFlow().ToPlainText(), false);
